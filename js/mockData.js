...
const INITIAL_DATA = {
  ...
  subjects: [
    { _id: 'sub_1', subjectCode: 'AD3501', subjectName: 'Deep Learning', credits: 4, facultyName: 'Dr. M. Senthil Kumar', department: 'AI & DS', semester: 'Semester V' },
    { _id: 'sub_2', subjectCode: 'CS3401', subjectName: 'Algorithms & Data Structures', credits: 3, facultyName: 'Prof. Anitha Raj', department: 'CSE', semester: 'Semester III' },
    { _id: 'sub_3', subjectCode: 'EC3302', subjectName: 'VLSI Systems', credits: 4, facultyName: 'Dr. R. Meenakshi', department: 'ECE', semester: 'Semester V' },
    { _id: 'sub_4', subjectCode: 'EE3403', subjectName: 'Control Systems', credits: 3, facultyName: 'Prof. G. Prakash', department: 'EEE', semester: 'Semester IV' },
    { _id: 'sub_5', subjectCode: 'ME3501', subjectName: 'Fluid Mechanics', credits: 4, facultyName: 'Dr. S. Karthik', department: 'Mechanical', semester: 'Semester V' }
  ],
  classes: [
    { _id: 'cls_1', className: 'III AI&DS A', department: 'AI & DS', year: 'III Year', semester: 'Semester V', section: 'A', classAdvisor: 'Dr. M. Senthil Kumar' },
    { _id: 'cls_2', className: 'III CSE B', department: 'CSE', year: 'III Year', semester: 'Semester V', section: 'B', classAdvisor: 'Prof. Anitha Raj' },
    { _id: 'cls_3', className: 'II ECE A', department: 'ECE', year: 'II Year', semester: 'Semester III', section: 'A', classAdvisor: 'Dr. R. Meenakshi' },
    { _id: 'cls_4', className: 'IV MECH A', department: 'Mechanical', year: 'IV Year', semester: 'Semester VII', section: 'A', classAdvisor: 'Dr. S. Karthik' }
  ],
  attendance: [
    { _id: 'att_1', studentRegisterNo: '953621104001', studentName: 'Aarav Kumar', department: 'AI & DS', semester: 'Semester V', date: '2026-07-19', status: 'Present', percentage: 96, remarks: 'On Time' },
    { _id: 'att_2', studentRegisterNo: '953621104002', studentName: 'Bhavna Sharma', department: 'AI & DS', semester: 'Semester V', date: '2026-07-19', status: 'Present', percentage: 98, remarks: 'On Time' },
    { _id: 'att_3', studentRegisterNo: '953621104003', studentName: 'Chandran V', department: 'CSE', semester: 'Semester V', date: '2026-07-19', status: 'Medical Leave', percentage: 88, remarks: 'Approved Medical Cert' },
    { _id: 'att_4', studentRegisterNo: '953621104004', studentName: 'Divya Dharshini', department: 'ECE', semester: 'Semester III', date: '2026-07-19', status: 'OD', percentage: 92, remarks: 'Symposium Duty' },
    { _id: 'att_5', studentRegisterNo: '953621104005', studentName: 'Elango N', department: 'Mechanical', semester: 'Semester VII', date: '2026-07-19', status: 'Present', percentage: 94, remarks: 'On Time' }
  ],
  semesterMarks: [
    { _id: 'sm_1', studentRegisterNo: '953621104001', studentName: 'Aarav Kumar', department: 'AI & DS', semester: 'Semester V', subjectCode: 'AD3501', subjectName: 'Deep Learning', grade: 'O', cgpa: 9.2, arrears: 0, result: 'PASS' },
    { _id: 'sm_2', studentRegisterNo: '953621104002', studentName: 'Bhavna Sharma', department: 'AI & DS', semester: 'Semester V', subjectCode: 'AD3501', subjectName: 'Deep Learning', grade: 'A+', cgpa: 8.9, arrears: 0, result: 'PASS' },
    { _id: 'sm_3', studentRegisterNo: '953621104003', studentName: 'Chandran V', department: 'CSE', semester: 'Semester V', subjectCode: 'CS3401', subjectName: 'Algorithms', grade: 'A', cgpa: 8.1, arrears: 0, result: 'PASS' },
    { _id: 'sm_4', studentRegisterNo: '953621104004', studentName: 'Divya Dharshini', department: 'ECE', semester: 'Semester III', subjectCode: 'EC3302', subjectName: 'VLSI Systems', grade: 'B+', cgpa: 7.5, arrears: 0, result: 'PASS' }
  ],
  internalMarks: [
    { _id: 'im_1', studentRegisterNo: '953621104001', studentName: 'Aarav Kumar', department: 'AI & DS', semester: 'Semester V', subjectCode: 'AD3501', subjectName: 'Deep Learning', internal1: 48, internal2: 46, modelExam: 92, assignment: 10, totalInternal: 98 },
    { _id: 'im_2', studentRegisterNo: '953621104002', studentName: 'Bhavna Sharma', department: 'AI & DS', semester: 'Semester V', subjectCode: 'AD3501', subjectName: 'Deep Learning', internal1: 45, internal2: 47, modelExam: 89, assignment: 10, totalInternal: 94 },
    { _id: 'im_3', studentRegisterNo: '953621104003', studentName: 'Chandran V', department: 'CSE', semester: 'Semester V', subjectCode: 'CS3401', subjectName: 'Algorithms', internal1: 40, internal2: 42, modelExam: 80, assignment: 9, totalInternal: 85 }
  ],
  history: [
